...
Merge |>
  ...
  (\(d) bind_cols(
    d |>
      slice_head(n = 10) |>
      transmute(`Lowest rates (2022)` = dep_label,
                `Rate (%)` = round(taux_chom, 2)),
    d |>
      slice_tail(n = 10) |>
      arrange(desc(taux_chom)) |>
      transmute(`Highest rates (2022)` = dep_label,
                `Rate (%)` = round(taux_chom, 2))
  ))() |>
  kable(
...
Merge |>
  ...
  (\(d) bind_cols(
    d |>
      slice_head(n = 10) |>
      transmute(`Lowest rates (2016)` = dep_label,
                `Rate (%)` = round(taux_chom, 2)),
    d |>
      slice_tail(n = 10) |>
      arrange(desc(taux_chom)) |>
      transmute(`Highest rates (2016)` = dep_label,
                `Rate (%)` = round(taux_chom, 2))
  ))() |>
  kable(
...
Merge |>
  ...
  filter(is.finite(taux_dem)) |>
  arrange(taux_dem) |>
  (\(d) bind_cols(
    d |>
      slice_head(n = 10) |>
      transmute(`Lowest rates (2022)` = nom_departement,
                `Mobility rate (%)` = round(taux_dem, 2)),
    d |>
      slice_tail(n = 10) |>
      arrange(desc(taux_dem)) |>
      transmute(`Highest rates (2022)` = nom_departement,
                `Mobility rate (%)` = round(taux_dem, 2))
  ))() |>
  kable(
    digits = 2,
...
Merge |>
  ...
  (\(d) bind_cols(
    d |>
      slice_head(n = 10) |>
      transmute(`Lowest rates (2016)` = nom_departement,
                `Mobility rate (%)` = round(taux_dem, 2)),
    d |>
      slice_tail(n = 10) |>
      arrange(desc(taux_dem)) |>
      transmute(`Highest rates (2016)` = nom_departement,
                `Mobility rate (%)` = round(taux_dem, 2))
  ))() |>
  kable(
    digits = 2,
